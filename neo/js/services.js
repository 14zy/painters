...
.factory('Painters', function () {
  ...
  var zh = [{
	...
	return {
		...
		basic: function () {
			var paintersSet = [];
			var paintersSetIDs = [1, 4, 7, 9, 14, 15, 17, 19, 21, 22, 24, 26, 27, 28, 29, 30, 32, 33, 34, 35, 36, 39, 40, 41, 42, 43, 45, 46, 49, 50, 53, 54, 55, 57, 58, 61, 62, 63, 69, 72, 73, 75, 77, 79, 80, 82, 83, 94, 95, 112, 118];
		...
		impressionism: function () {
			var paintersSet = [];
			var paintersSetIDs = [2, 3, 9, 16, 17, 21, 30, 36, 49, 53, 57, 60, 61, 69, 77, 84, 94, 96];
			angular.forEach(painters, function (value) {
				if (paintersSetIDs.indexOf(value.id) > -1) {
					this.push(value)
				}
		...
		renaissance: function () {
			var paintersSet = [];
			var paintersSetIDs = [24, 35, 39, 41, 42, 45, 50, 55, 87, 89, 90, 91, 92, 95, 98, 100, 101, 104, 106, 108, 110, 111, 112, 114];
			angular.forEach(painters, function (value) {
				if (paintersSetIDs.indexOf(value.id) > -1) {
					this.push(value)
				}
		...
		realism: function () {
			var paintersSet = [];
			var paintersSetIDs = [5, 8, 18, 25, 37, 47, 48, 58, 85, 113, 116, 117];
			angular.forEach(painters, function (value) {
				if (paintersSetIDs.indexOf(value.id) > -1) {
					this.push(value)
				}
		...
		french: function () {
			var paintersSet = [];
			var paintersSetIDs = [2, 9, 17, 30, 36, 40, 49, 53, 57, 58, 61, 64, 65, 69, 70, 73, 75, 77, 93, 94, 96, 97];
			angular.forEach(painters, function (value) {
				if (paintersSetIDs.indexOf(value.id) > -1) {
					this.push(value)
				}
